...
class AppStore extends Component {
  ...
  getFilteredAppsList = () => {
    ...
    const filteredAppsList = appsList.filter(eachFilter =>
      eachFilter.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )
  ...
  getTheActiveTabsList = () => {
    ...
    const activeTabsFilterList = filteredAppsList.filter(
      eachAppList => eachAppList.category === activeTabsId,
    )
  ...
  render() {
    ...
    return (
      <div className="app-container">
        ...
        <ul className="play-store-apps">
          {activeTabsFilterList.map(eachApp => (
